    ...
    for subject_label in subjects_to_analyze:
        ...
        for session_dir in session_dirs:
            ...
            for T1_file in glob(os.path.join(anat_dir, "*_T1w.nii*")):
                ...
                cmd = f"./preprocess_and_predict.sh {T1_file} {filename} sub-{subject_label} {output_subdir} {args.pythonpath} {args.gpuid} {args.masks} {args.pred_method} {args.n_areas} {args.modeldir} {args.ntol} ses-{session}"
                run(cmd)
